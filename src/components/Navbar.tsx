        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-1">
            {navItems.map((item, index) => (
              <motion.a
                ...
                className="relative px-4 py-2 text-sm font-medium text-gray-900 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors group"
              >
                {item.name}
          ...
          <div className="md:hidden flex items-center space-x-2">
            ...
            <button
              ...
              className="p-2 text-gray-900 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
            >
              ...
              <div className="px-2 py-3 space-y-1">
                {navItems.map((item, index) => (
                  <motion.a
                    ...
                    className="block px-4 py-3 text-gray-900 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-100/50 dark:hover:bg-blue-900/20 rounded-xl font-medium transition-all"
