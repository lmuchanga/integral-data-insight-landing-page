        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-4">
              ...
              <a
                href="#"
                className="text-gray-400 hover:text-pink-600 transition-colors group"
                aria-label="Instagram"
              >
                <svg className="h-5 w-5 group-hover:[filter:url(#instagram-glow)]" viewBox="0 0 24 24" fill="url(#footer-insta-gradient)">
                  <defs>
