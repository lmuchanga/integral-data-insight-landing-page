...
const About = () => {
  return (
    <section id="about" className="py-24 relative overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0 bg-gradient-to-b from-blue-50/30 via-transparent to-purple-50/30 dark:from-blue-950/10 dark:via-transparent dark:to-purple-950/10 -z-10" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="relative p-8 rounded-3xl glass-card overflow-hidden">
                ...
                <ul className="space-y-4 relative">
                  {[
                    ...
                    >
                      <span className="mr-3 text-blue-500 dark:text-blue-400 text-lg">✓</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-br from-blue-500/10 to-blue-600/10 rounded-3xl blur-xl group-hover:blur-2xl transition-all" />
          ...
          <motion.div
            ...
            className="relative group"
          >
            <div className="absolute inset-0 bg-gradient-to-br from-purple-500/10 to-purple-600/10 rounded-3xl blur-xl group-hover:blur-2xl transition-all" />
            <div className="relative p-8 rounded-3xl glass-card h-full">
              <div className="flex items-center mb-6">
